...
import sars.pca.app.common.DatasourceUtility;

@Configuration
@EnableJpaRepositories(basePackages = {"sars.pca.app.persistence"}, transactionManagerRef = "transactionManager")
@ComponentScan(basePackages = {"sars.pca.app"})
...
public class TestDataSourceConfiguration {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactoryBean() {
        ...
        localContainerEntityManagerFactoryBean.setPackagesToScan("sars.pca.app.domain");
